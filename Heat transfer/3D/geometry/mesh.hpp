...
class Mesh {
private:
    float problem_data[2];                  // Array to store problem data (thermal conductivity, heat source)
    int quantities[4];                      // Array to store different quantities (number of nodes, elements, Dirichlet conditions, Neumann conditions)
    Node** nodes;                           // Array of pointers to Node objects
    Element** elements;                     // Array of pointers to Element objects
    Condition** dirichlet_conditions;       // Array of pointers to Dirichlet Condition objects
    Condition** neumann_conditions;         // Array of pointers to Neumann Condition objects
...
public:
    ...
    // Setter and getter for problem data
    ...
    // Setter and getter for quantities
    ...
    // Insert and retrieve Dirichlet conditions
    ...
    // Insert and retrieve Neumann conditions
    ...
    // Print a report with mesh information
    void report() {
        cout << "Problem Data\n**********************\n";
