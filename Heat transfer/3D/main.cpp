...
int main(int argc, char** argv) {
    ...
    // Write a timestamp and message to the output file and console for reading the input file
    ...
    // Write a timestamp and message to the output file and console for local systems
    ...
    // Write a timestamp and message to the output file and console for assembly
    ...
    // Write a timestamp and message to the output file and console for Neumann boundary conditions
    ...
    // Write a timestamp and message to the output file and console for Dirichlet boundary conditions
    timesFile << "[" << getCurrentTimestamp() << "] Applying Dirichlet Boundary Conditions...\n\n";
    cout << "Applying Dirichlet Boundary Conditions...\n\n";
    // Apply Dirichlet boundary conditions to the global system of equations
    apply_dirichlet_boundary_conditions(&K, &b, &M);

    //K.show(); b.show();

    // Write a timestamp and message to the output file and console for solving the global system
    ...
    // Write a timestamp and message to the output file and console for preparing results
    ...
    // Write a timestamp and message to the output file and console for writing the output file
