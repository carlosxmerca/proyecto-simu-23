...
void read_input(string filename, Mesh* M) {
    ...
    // Read Dirichlet boundary condition data and insert conditions into the Mesh object
    ...
    // Read Neumann boundary condition data and insert conditions into the Mesh object
...
void write_output(string filename, Vector* T) {
    ...
    // Write temperature results to the output file
